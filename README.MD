...
> 📌 *Pendiente: agregar captura de MySQL Workbench abierto con la conexión local visible.*
...
> 📌 *Pendiente: agregar captura con el resultado de la query mostrando la versión, usuario y fecha.*
